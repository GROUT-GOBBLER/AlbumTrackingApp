...
public class NewAlbumView extends JPanel implements ActionListener {
    ...
    // Swing components.
        ...
        private JPanel user_entry, album_title_panel, artist_name_panel, genre_panel, release_year_panel, rating_panel, review_panel;    
        private JTextField album_title_textfield, artist_name_textfield, genre_textfield, release_year_textfield, rating_textfield;
        private JTextArea review_textarea;
    ...
    // Used in NewAlbumView constructor.
        private void buildInputPanels() { 
            ...
            // Create other panels to go in user_entry.
                album_title_panel = new JPanel();
                    ...
                    album_title_panel.setMaximumSize(album_title_panel.getPreferredSize());
                ...
                artist_name_panel = new JPanel();
                    ...
                    artist_name_panel.setMaximumSize(artist_name_panel.getPreferredSize());
                ...
                release_year_panel = new JPanel();
                    ...
                    release_year_panel.add(new JLabel("Release Year: "));
                    release_year_panel.add(release_year_textfield);
                    release_year_panel.setMaximumSize(release_year_panel.getPreferredSize());
                ...
                rating_panel = new JPanel();
                    ...
                    rating_panel.setMaximumSize(rating_panel.getPreferredSize());

                review_panel = new JPanel();
                    buildReviewTextArea();
                    review_panel.add(new JLabel("Review: "));
                    
                    JScrollPane scroll_pane = new JScrollPane(review_textarea, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_NEVER);
                    scroll_pane.setBounds(0,0,10,30);
                    
                    review_panel.add(scroll_pane);
                    review_panel.setMaximumSize(review_panel.getMaximumSize());
        ...
        private void buildReviewTextArea() {
            review_textarea = new JTextArea(10, 30);
        ...
        if(userInputValidation()) {
            try {
                if (saveDataCheck()) { // Save data found. 
                    ...
                    Object obj;
                    try (FileReader file_reader = new FileReader(file_name)) {
            ...
            JOptionPane.showMessageDialog(null, "Please fill out each field.", "", JOptionPane.INFORMATION_MESSAGE);
        }
    }
    
    // Used in actionPerformed().
        public boolean userInputValidation() {
            // Returns true for good input, false for bad input.
            return (!album_title_textfield.getText().equals("") && !artist_name_textfield.getText().equals("") && 
                    !genre_textfield.getText().equals("") && !release_year_textfield.getText().equals("") && 
                    !rating_textfield.getText().equals("") && !review_textarea.getText().equals(""));
        }
        ...
        public JSONObject buildJSONObject() {
            JSONObject temp_json_object = new JSONObject();
                ...
                temp_json_object.put("Review", review_textarea.getText());
